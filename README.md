...
1. About
2. Installing
3. When a new bundled module is installed in remote
4. Update all bundled modules
5. Install a new bundled module
6. Remove an existing bundled module
7. Authors
8. Contributing
...
## When a new bundled module is installed in remote
...
## Remove an existing bundled module
